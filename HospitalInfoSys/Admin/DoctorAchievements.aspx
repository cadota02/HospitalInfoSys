<%@ Page Title="Doctor Achievements" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="DoctorAchievements.aspx.cs" Inherits="HospitalInfoSys.Admin.DoctorAchievements" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <h4 class="text-center text-primary">Manage Doctor Achievements</h4>
        <hr>
            <div class="row">
                <div class="col-md-12">
                   <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                                     ...
                                     OnClick="btn_add_Click">Add Doctor Achievements</asp:LinkButton>
                                                </div>
                                       ...
                                       <HeaderTemplate> # </HeaderTemplate>
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lbl_no" runat="server" Text="<%# Container.DataItemIndex + 1 %>  "></asp:Label>
                                                ...
                                                <asp:ImageField DataImageUrlField="photo_url" HeaderText="Photo" ItemStyle-HorizontalAlign="Center" ControlStyle-Width="60px" ControlStyle-Height="60px" />
                                               <asp:BoundField DataField="Fullname" HeaderText="Doctor Name"  />
                                                <asp:BoundField DataField="descriptions" HeaderText="Description"   />
                                      <asp:BoundField DataField="specialty" HeaderText="Specialty"    ItemStyle-HorizontalAlign="Left" />
    ...
    <div class="modal-content">
        <span class="close" onclick="closeModal()">&times;</span>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
        <asp:HiddenField ID="hd_achievementid" Value="0" runat="server" />
        <h4 id="modalTitle" style="text-align: center">Add Doctor Achievements</h4>
        <hr />
        <div class="form-group">
        <div class="col-sm-12">
            <label class="form-label">Doctor Name
                 <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" SetFocusOnError="true" ControlToValidate="dpdoctor" InitialValue="Select Doctor" ErrorMessage=" is required." CssClass="text-danger" Display="Dynamic"  ValidationGroup="add"></asp:RequiredFieldValidator>
            </label>
            <asp:DropDownList ID="dpdoctor" CssClass="form-control"  runat="server"></asp:DropDownList>
             
               
            </div>
           <div class="col-sm-12">
                <label class="form-label">Achievements Details
                             <asp:RequiredFieldValidator ID="rfvLastName" runat="server" SetFocusOnError="true" ControlToValidate="txtdescription" ErrorMessage=" is required." CssClass="text-danger" Display="Dynamic"  ValidationGroup="add"></asp:RequiredFieldValidator>
                </label>
                <asp:TextBox ID="txtdescription" runat="server" CssClass="form-control" placeholder="Enter Achievements" TextMode="MultiLine" Rows="3"></asp:TextBox>
...
<script type="text/javascript">
    ...
    function openModal(userId) {
        ...
        if (userId > 0) {
            title.innerHTML = "Edit Achievements";
           
            document.getElementById("<%= btnRegister.ClientID %>").value = "Update";
        } else {
            title.innerHTML = "Add Achievements";
